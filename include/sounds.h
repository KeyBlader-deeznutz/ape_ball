...
#define SOUND_NEW_BALLS                                           SOUND_ARG_LOAD(SOUND_BANK_NEW, 0x01, 0x80, SOUND_DISCRETE)
#define SOUND_NEW_RAGDOLL                                         SOUND_ARG_LOAD(SOUND_BANK_NEW, 0x02, 0x80, SOUND_DISCRETE)
#define SOUND_NEW_STEAMHAPPY                                      SOUND_ARG_LOAD(SOUND_BANK_NEW, 0x03, 0xFF, SOUND_DISCRETE)
#define SOUND_NEW_MARIOSAYSFUCK                                   SOUND_ARG_LOAD(SOUND_BANK_NEW, 0x04, 0xFF, SOUND_DISCRETE)
...
#define SOUND_NEW_CRASH                                           SOUND_ARG_LOAD(SOUND_BANK_NEW, 0x07, 0xFF, SOUND_DISCRETE)
