...
const LevelScript level_bob_entry[] = {
	...
	AREA(6, bob_area_6),
		...
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_REAL_COIN, -2307, -1216, -1401, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, -363, -1923, 795, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, 889, -517, -2121, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, -1828, 43, 3196, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, 1045, 642, -889, 0, 90, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, 1045, 733, -2, 0, 90, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, 1045, 642, 936, 0, 90, 0, 0x00000000, bhvStageCoin),
	...
	AREA(7, bob_area_7),
		...
		OBJECT(MODEL_NONE, -6278, 36, 32, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
