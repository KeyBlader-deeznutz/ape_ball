...
const GeoLayout bob_area_4_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bob_dl_visuals_003_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, bob_dl_visuals_003_mesh_layer_7),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, bob_dl_visuals_003_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_visuals_003_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_area_4[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 37500, 0, 0, 37500, -100, 0, geo_camera_main),
				GEO_OPEN_NODE(),
