...
const LevelScript level_wf_entry[] = {
	...
	AREA(5, wf_area_5),
		...
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_REAL_COIN, 5849, 3259, -1671, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, -4558, 3259, -1801, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, 3186, 3259, 2924, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, -2375, 3259, 2728, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, 3423, 3259, -5660, 0, 0, 0, 0x00000000, bhvStageCoin),
		OBJECT(MODEL_REAL_COIN, -2315, 3259, -5569, 0, 0, 0, 0x00000000, bhvStageCoin),
	...
	AREA(6, wf_area_6),
		...
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 19, 831, -8244, 0, 0, 0, 0x00000000, bhvViewAligner),
		OBJECT(MODEL_STAGE16, 0, 0, 0, 0, 0, 0, (16 << 16), bhvTestplane),
		OBJECT(MODEL_NONE, 32, 909, -7582, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
